...
function addLoyaltyPoints(userId, purchaseAmount) {
    return __awaiter(this, void 0, void 0, function () {
        var pointsToAdd, existing;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    pointsToAdd = Math.floor(purchaseAmount * 0.1);
                ...
                case 2:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, db_1.db.insert(schema_1.loyaltyPoints).values({
                        userId: userId,
                        points: pointsToAdd,
                    })];
                case 4:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    record = _a.sent();
                    return [2 /*return*/, record.length > 0 ? record[0].points : 0];
            }
        });
    });
}
