...
exports.userProfilesRelations =
  exports.readerProfile =
  exports.creatorProfile =
...
exports.readerProfile = (0, pg_core_1.pgTable)("reader_profile", {
  ...
  walletId: (0, pg_core_1.varchar)("wallet_id", { length: 12 })
    .notNull()
    .unique(),
  pinHash: (0, pg_core_1.text)("pin_hash"),
  createdAt: (0, pg_core_1.timestamp)("created_at", { mode: "date" })
...
exports.userProfilesRelations = (0, drizzle_orm_1.relations)(
  exports.userProfiles,
  function (_a) {
    var one = _a.one;
    return {
